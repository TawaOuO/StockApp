...
public class MyPagerAdapter extends PagerAdapter {
    ...
    private String a;
//    OnAdapterRespond onAdapterRespond;

    public MyPagerAdapter(List<View> mPager) {//請記得新增建構子喔！(ﾟAﾟ;)
        this.mPager = mPager;//分頁陣列要由PickActivity傳入
    }
...
//        Pagers pager = new Pagers(mPager.get(getCount()).getContext(), getCount());
//        pager.onPagersRespond = new Pagers.OnPagersRespond() {
//            @Override
//            public void onRespond(String selected) {
//                a = selected;
//            }
//        };
//        onAdapterRespond.onRespond1(a);
//    }
...
//    interface OnAdapterRespond{
//        void onRespond1(String selected);
//    }
