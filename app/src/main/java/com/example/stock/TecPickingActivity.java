...
public class TecPickingActivity extends Activity {
    ...
    public String CheckNum(){
        ...
        try {
            CSVReader reader = new CSVReader(new InputStreamReader(
                    (com.example.stock.TecPickingActivity.this).getAssets().open("123.csv")
            ));
            String[] nextLine;
            reader.readNext();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picking_tec);
        ...
        mBtnReturnHomePage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(
                        TecPickingActivity.this, HomeActivity.class);
        ...
        mBtnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent;
                intent = new Intent(
                        TecPickingActivity.this, End.class);
